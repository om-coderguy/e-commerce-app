      ...
      <template v-slot:top>
        ...
        <v-toolbar flat>
          ...
          <v-dialog v-model="dialog" max-width="500px">
            ...
            <v-card>
              <v-form @submit.prevent="save(editedItem.userId)" v-model="subUserInfo">
                <v-card-title>
                  <span class="text-h5">{{ isEdit ? "Edit" : "Add" }} Sub User</span>
                </v-card-title>
                ...
                <v-card-actions>
                  ...
                  <v-btn color="blue darken-1" text type="submit" :disabled="!subUserInfo">Save</v-btn>
                </v-card-actions>
              </v-form>
            </v-card>
          </v-dialog>
    ...
    methods: {
      ...
      save(userId) {
        ...
        const request = this.isEdit
          ? axios.put(`${urls().subUser}/${this.editedItem.subUserId}`, this.editedItem)
