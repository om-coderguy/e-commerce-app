<template>
  <div class="product">
    <!-- Product Card -->
    <v-card
      class="ma-5 green lighten-4 d-flex align-center"
      max-width="680"
      width="680"
      min-height="250"
      outlined
    >
      ...
      <v-list-item>
        ...
        <v-list-item-content class="ml-10">
          ...
          <!-- Discount Percentage -->
          <div class="text-overline discount">{{ product.discount }}% off</div>
        </v-list-item-content>
      </v-list-item>
    </v-card>
    ...
    >
      ...
      <v-form @submit.prevent="submitReview">
        <v-text-field
          ...
          required
        ></v-text-field>
        <v-btn type="submit" color="blue" class="mt-3"> Submit Review </v-btn>
      </v-form>
    </v-card>
...
export default {
  ...
  methods: {
    ...
    fetchReviews(productId) {
      ...
      axios
        .get(urls().products + "/reviews/" + productId, {})
        .then((response) => {
